...
const { servicioExiste, agregarServicio,obtenerServicio, obtenerServicios } = serviciosStore();
...
function modificaruser(idEmpleados) {
  ...
  router.push({ name: "actualizarUsuario"});
}
                ...
                <div class="d-inline-flex">
                  <button
                    ...
                    style="
                      ...
                      width: 45px;
                    "
                    @click="modificaruser(servicio.idServicios)"
                  >
                    <i
