  ...
  >
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div v-if="modeloOriginal!=modelo" class="modal-body">La moto "{{ modeloOriginal }}" fue actualizada a "{{ modelo }}" exitosamente.</div>
        <div v-if="modeloOriginal==modelo" class="modal-body">La moto "{{ modelo }}" fue actualizada exitosamente.</div>
        <div class="modal-footer">
          <button type="button" class="btn btn-success" @click="volverAMotos()">
            Confirmar
          </button>
